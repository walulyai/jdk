 ...
 * @summary Make sure G1GC can recover from humongous allocation fragmentation (FIXME: Test taken from shenandoah - fix copyright )
 * @key randomness
 * @requires vm.gc.G1
 * @library /test/lib
 *
 * @run main/othervm -Xmx1g -Xms1g  -XX:+UnlockDiagnosticVMOptions -XX:+UnlockExperimentalVMOptions 
 * -XX:VerifyGCType=full -XX:+VerifyAfterGC -XX:+VerifyBeforeGC -XX:+VerifyDuringGC -Xlog:gc+region=trace
