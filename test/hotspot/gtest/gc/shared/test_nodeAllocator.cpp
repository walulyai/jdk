...
public:
  static bool try_transfer_pending(BufferNodeAllocator* allocator) {
...
// Some basic testing of NodeAllocator.
TEST_VM(BufferNodeAllocatorTest, test) {
  const size_t buffer_size = 256;
  BufferNodeAllocator allocator("Test Buffer Allocator", buffer_size);
...
static void run_test(BufferNodeAllocator* allocator, CompletedList* cbl) {
...
TEST_VM(BufferNodeAllocatorTest, stress_free_list_allocator) {
  BufferNodeAllocator allocator("Test Allocator", buffer_size);
